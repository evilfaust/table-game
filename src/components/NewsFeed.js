...
//       <Content style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
  return (
    <Layout style={{ background: 'transparent' }}>
      <Layout.Content style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
...
//               <a href={`https://vk.com/wall${selectedNews.owner_id}_${selectedNews.id}`} target="_blank" rel="noopener noreferrer">
//                 Открыть в ВК
//               </a>
//             </>
//           )}
